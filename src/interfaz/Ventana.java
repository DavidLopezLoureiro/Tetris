...
public class Ventana extends JFrame implements KeyListener {
	...
	public Ventana() {
		...
		try {
            ...
            sonido.open(AudioSystem.getAudioInputStream(getClass().getResourceAsStream("/imagenes/WhatsApp Audio 2020-01-12 at 21.42.46 (1).wav")));
				...
				//si termina la aplicacion
					try {
						...
						for (int i = 0; i < 9; i++) {
							...
							if (campo[20][i] != null) {
								//a̱adimos la puntuacion en la base de datos
						...
						for (int u = 0; u < 21; u++) {
							...
							while (campo[u][0] != null && campo[u][1] != null && campo[u][2] != null && campo[u][3] != null
								...
								IniciarSesion.entrada.setMaxPuntu(IniciarSesion.entrada.getMaxPuntu() + 1);//a̱adimos la puntuacion 
